...
1. Download `DH-Audio-Toolkit-3.11.zip` from the [GitHub Releases](https://github.com/dayhawk-labs/DH-Audio-Toolkit/releases) page.
2. Extract the folder named `DH Audio Toolkit 3.11`.
